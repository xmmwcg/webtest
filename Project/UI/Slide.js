...
*/
KISSY.add('UI/Slide/slide-util',function(S){
...
KISSY.add('UI/Slide/kissy2yui',function(S){
...
KISSY.add('UI/Slide/base',function(S){
	...
	requires:['node','event','json','UI/Slide/slide-util','UI/Slide/kissy2yui']	
});




KISSY.add('UI/Slide',function(S,BSlide){

	return BSlide;

},{
	requires:['UI/Slide/base']	
});
